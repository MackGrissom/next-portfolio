      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="grid gap-8 md:grid-cols-12">
          <div className="md:col-span-2">
            <span className="text-6xl font-bold leading-none text-accent/30">&ldquo;</span>
          </div>
          <div className="md:col-span-7">
            <p className="text-lg font-medium leading-relaxed tracking-tight md:text-xl lg:text-2xl">
              {t.quote}
            </p>
          </div>
