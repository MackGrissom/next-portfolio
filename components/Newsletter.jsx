...
const IntroMessage = () => (
  <div className="prose dark:prose-invert">
    <h3>
      <em>Join My Mailing List! </em>
    </h3>
    <h6>Want to stay up to date with industry trends?</h6>
    <small>
      The latest and greatest articles, links, news and discounts related to web development delivered directly to your
      inbox.
    </small>
  </div>
)
